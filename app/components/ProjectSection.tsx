        ...
        <div className="h-screen w-screen flex flex-col justify-center items-center relative font-bold leading-normal group text-center px-10">
          ...
          <div className="invisible">
            <Image
              ...
              width="480"
              height="480"
              className="group-hover:visible transition-opacity ease-in-out opacity-0 group-hover:opacity-10 delay-75 duration-200 z-0 absolute h-auto w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-x-hidden"
            />
